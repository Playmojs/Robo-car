# 1 "D:\\Programs\\Github Repositories\\Robo-car\\Robo-car.ino"
# 2 "D:\\Programs\\Github Repositories\\Robo-car\\Robo-car.ino" 2
# 3 "D:\\Programs\\Github Repositories\\Robo-car\\Robo-car.ino" 2
...
void setup()
{
   ...
   pinMode(EnB, 0x1);
   pinMode(13, 0x1);
   pinMode(input_pin, 0x0);
   pinMode(output_pin, 0x1);
   servo.attach(5);
   Wire.begin();
   compass.init();
...
{
   digitalWrite(pinRB,0x0);
   digitalWrite(pinRF,0x1);
   digitalWrite(pinLB,0x0);
   digitalWrite(pinLF,0x1);
   analogWrite(EnA, 255);
   analogWrite(EnB, 255);
}
void TurnL() //turn left
{
   digitalWrite(pinRB,0x0);
   digitalWrite(pinRF,0x1);
   digitalWrite(pinLB,0x1);
   digitalWrite(pinLF,0x0);
   analogWrite(EnA, 150);
   analogWrite(EnB, 150);
}
void TurnR() //turn right
{
   digitalWrite(pinRB,0x1);
   digitalWrite(pinRF,0x0);
   digitalWrite(pinLB,0x0);
   digitalWrite(pinLF,0x1);
   analogWrite(EnA, 150);
   analogWrite(EnB, 150);
...
{
    digitalWrite(output_pin, 0x0);
    delayMicroseconds(2);
    digitalWrite(output_pin, 0x1);
    delayMicroseconds(10);
    digitalWrite(output_pin, 0x0);
    float Fdistance = pulseIn(input_pin, 0x1);
...
# 1 "D:\\Programs\\Github Repositories\\Robo-car\\Robo_car_BT.ino"
...
//     //delay(20);
// }
# 1 "D:\\Programs\\Github Repositories\\Robo-car\\Servo_test.ino"
// #include <Servo.h>
